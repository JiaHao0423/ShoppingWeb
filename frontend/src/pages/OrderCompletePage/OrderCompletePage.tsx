  ...
  return (
    <div className="order-complete">
      <header className="order-complete__header">
        <button className="order-complete__back-btn" onClick={handleGoBack} aria-label="返回">
      ...
      <main className="order-complete__content">
        <div className="order-complete__message">
          <div className="order-complete__icon-wrapper">
            <svg className="order-complete__success-icon" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="32" cy="32" r="28" stroke="#4CAF50" strokeWidth="3" />
              <path d="M20 33L28 41L44 25" stroke="#4CAF50" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>

          <h2 className="order-complete__heading">付款成功</h2>

          <button className="order-complete__browse-btn" onClick={handleBrowseProducts}>
            逛逛其他商品
          </button>
        </div>
      </main>
